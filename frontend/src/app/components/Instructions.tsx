          ...
          <div className="bg-white rounded-lg shadow-sm border border-teal-100 p-8">
            ...
            <div className="mt-8 p-4 bg-amber-50 border border-amber-200 rounded-lg">
              <div className="flex gap-3">
                ...
                <div>
                  <p className="text-amber-900 font-[ADLaM_Display] text-[13px]">Medical Disclaimer: This tool is for preliminary screening only and does not replace professional medical diagnosis. Always consult a healthcare provider for proper evaluation <strong></strong></p>
                </div>
              </div>
            </div>
